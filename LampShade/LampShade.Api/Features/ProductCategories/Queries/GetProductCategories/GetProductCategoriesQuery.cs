...
namespace LampShade.Api.Features.ProductCategories.Queries.GetProductCategories;
...
public class GetProductCategoriesQueryHandler : IRequestHandler<GetProductCategoriesQuery, List<ProductCategoryViewModel>>
{
    ...
    public async Task<List<ProductCategoryViewModel>> Handle(GetProductCategoriesQuery r, CancellationToken c) => await Task.FromResult(_application.GetProductCategories());
}
