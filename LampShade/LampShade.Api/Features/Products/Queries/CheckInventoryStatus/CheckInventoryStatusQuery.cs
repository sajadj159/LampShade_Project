...
namespace LampShade.Api.Features.Products.Queries.CheckInventoryStatus;
...
public class CheckInventoryStatusQueryHandler : IRequestHandler<CheckInventoryStatusQuery, List<CartItem>>
{
    ...
    public async Task<List<CartItem>> Handle(CheckInventoryStatusQuery request, CancellationToken cancellationToken)
    {
        ...
        return await Task.FromResult(_productQuery.CheckInventoryStatus(cartItems));
    }
}
