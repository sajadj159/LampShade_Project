...
namespace LampShade.Api.Features.ProductPictures.Queries.GetProductPictureById;
...
public class GetProductPictureByIdQueryHandler : IRequestHandler<GetProductPictureByIdQuery, EditProductPicture>
{
    ...
    public async Task<EditProductPicture> Handle(GetProductPictureByIdQuery request, CancellationToken cancellationToken)
    {
