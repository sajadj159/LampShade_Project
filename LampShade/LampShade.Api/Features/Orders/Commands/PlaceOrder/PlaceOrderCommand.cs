...
namespace LampShade.Api.Features.Orders.Commands.PlaceOrder;
...
public class PlaceOrderCommandHandler : IRequestHandler<PlaceOrderCommand, long>
{
    ...
    public async Task<long> Handle(PlaceOrderCommand request, CancellationToken cancellationToken)
    {
        ...
        return await Task.FromResult(_application.PlaceOrder(cart));
    }
}
